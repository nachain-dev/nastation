...
@PageTitle(TempFileItemListView.Page_Title)
@Route(value = "TempFileItemListView/:fileItemID?/:action?(edit)", layout = MainLayout.class)
public class TempFileItemListView extends Div implements BeforeEnterObserver {

    public static final String Route_Value = "TempFileItemListView";
    public static final String Page_Title = "Temp File List";

    private final String FILE_ITEM_ID = "fileItemID";
    private final String FILE_ITEM_EDIT_ROUTE_TEMPLATE = "TempFileItemListView/%d/edit";
    ...
    public TempFileItemListView(@Autowired FileItemService fileItemService) {
        ...
        grid.addColumn(new ComponentRenderer<>(Div::new, (div, rowData) -> {
            ...
            pin.addThemeVariants(ButtonVariant.LUMO_PRIMARY, ButtonVariant.LUMO_SUCCESS,ButtonVariant.LUMO_SMALL);
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(TempFileItemListView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (fileItemId.isPresent()) {
            ...
            if (fileItemFromBackend.isPresent()) {
                ...
                Notification.show(String.format("The requested fileItem was not found, ID = %d", fileItemId.get()),3000, Notification.Position.BOTTOM_START);
                refreshGrid();
                event.forwardTo(TempFileItemListView.class);
            }
        }
    }
    ...
    private void createEditorLayout(SplitLayout splitLayout) {
        Div div = new Div();
        div.setClassName("flex flex-col");
        div.setWidth("400px");
        ...
        Component[] fields = new Component[]{id,fileName, fileSize, fileType, addTime};
