...
import org.nastation.components.layout.size.Wide;
...
public class ListItem extends FlexBoxLayout {
	...
	public ListItem(String primary, String secondary) {
		...
		this.secondary = CompUtil.createLabel(FontSize.S, TextColor.SECONDARY,
				secondary);
	...
	public void setWhiteSpace(WhiteSpace whiteSpace) {
		CompUtil.setWhiteSpace(whiteSpace, this);
	}
