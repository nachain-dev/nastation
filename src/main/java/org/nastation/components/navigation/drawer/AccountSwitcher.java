...
public class AccountSwitcher extends Div {
	...
	private void initEmail() {
		email = new Label("john.smith@na.org");
		email.addClassName(CLASS_NAME + "__email");

		dropdown = CompUtil.createButton(VaadinIcon.ANGLE_DOWN, ButtonVariant.LUMO_SMALL, ButtonVariant.LUMO_TERTIARY);
		email.add(dropdown);

		menu = new ContextMenu(dropdown);
		menu.setOpenOnClick(true);
		menu.addItem("john.smith@na.org", e -> System.out.println("Testing..."));
		menu.addItem("john.smith@na.org", e -> System.out.println("Testing..."));
