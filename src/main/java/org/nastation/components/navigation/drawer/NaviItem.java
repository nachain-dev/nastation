...
public class NaviItem extends Div {
	...
	public NaviItem(String text, Class<? extends Component> navigationTarget) {
		...
		expandCollapse = CompUtil.createButton(VaadinIcon.CARET_UP, ButtonVariant.LUMO_SMALL, ButtonVariant.LUMO_TERTIARY);
	...
	private void updateAriaLabel() {
		...
		CompUtil.setAriaLabel(action, expandCollapse);
	}
