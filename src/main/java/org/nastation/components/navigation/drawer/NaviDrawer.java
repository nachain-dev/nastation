...
public class NaviDrawer extends Div
	...
	private void initHeader() {
		mainContent.add(new BrandExpression("Egg"));
	}
	...
	private void initFooter() {
		railButton = CompUtil.createSmallButton("Collapse", VaadinIcon.CHEVRON_LEFT_SMALL);
