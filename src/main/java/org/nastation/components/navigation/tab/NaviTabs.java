...
import org.nastation.components.style.css.Overflow;
...
public class NaviTabs extends Tabs {
	...
	public NaviTabs() {
		...
		CompUtil.setOverflow(Overflow.HIDDEN, this);
	}
	...
	public void navigateToSelectedTab() {
		if (getSelectedTab() instanceof NaviTab) {
			try {
				...
				// @ this is an code flow by exception anti-pattern. Either
				// handle the case without the exception, or
				// @ at least document meticulously why this can't be done
				...
				// @ this block consumes all exceptions, even
				// mysteriously.
